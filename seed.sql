...
INSERT INTO exercises (name, description, muscle_group, difficulty, equipment_required, instructions, contraindications, video_url, image_url) VALUES

('Jumping Jacks', 'Classic cardio warm-up', 'Full Body', 'beginner', 0, 'Stand with feet together, jump while spreading legs and raising arms overhead, return to start', 'Avoid if you have knee or ankle issues', NULL, '/images/exercises/jumping_jacks.png'),
('Arm Circles', 'Shoulder warm-up', 'Shoulders', 'beginner', 0, 'Extend arms to sides, make small circles, gradually increase size', 'None', NULL, '/images/exercises/arm_circles.png'),
('Bodyweight Squats', 'Leg warm-up and strength', 'Legs', 'beginner', 0, 'Feet shoulder-width apart, lower hips back and down, keep chest up, return to standing', 'Be cautious with knee injuries', NULL, '/images/exercises/bodyweight_squats.png'),
...
('Dead Bug', 'Core control', 'Core', 'beginner', 0, 'Lie on back, extend opposite arm and leg while keeping lower back pressed to floor', 'Safe for herniated disks', 'https://www.youtube.com/watch?v=4XLEnwUr1d8', '/images/exercises/dead_bug.png'),
...
INSERT INTO exercises (name, description, muscle_group, difficulty, equipment_required, instructions, contraindications, video_url, image_url) VALUES
('Dumbbell Chest Press', 'Chest strength', 'Chest', 'beginner', 1, 'Lie on bench, press dumbbells up from chest level', 'Avoid if shoulder issues', 'https://www.youtube.com/watch?v=VmB1G1K7v94', '/images/exercises/dumbbell_chest_press.png'),
